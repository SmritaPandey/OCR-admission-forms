# 🎯 Complete Training Guide - Test OCR & Train CRAFT+TR-OCR
...
3. Configure training (epochs: 20, batch-size: 8)
...
- Verify a form in browser to create annotation automatically

### Training Fails
- Check PyTorch: `python3 -c "import torch; print(torch.__version__)"`
- Need PyTorch >= 2.1
- Check training data: `cat training_data/annotated_forms_training.json | head -20`
