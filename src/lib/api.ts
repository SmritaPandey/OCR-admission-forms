...
export const apiService = {
  ...
  exportDocuments: async (format: string, filters?: any): Promise<Blob> => {
  ...
  exportStudents: async (format: string, filters?: any): Promise<Blob> => {
    // API endpoint is /api/students/export/{format}
    const response = await api.get(`/api/students/export/${format}`, {
      params: filters,
      responseType: 'blob',
    });
    return response.data;
  ...
  exportStudentsCSV: async (filters?: any): Promise<Blob> => {
  ...
  exportStudentsExcel: async (filters?: any): Promise<Blob> => {
  ...
  exportStudentsJSON: async (filters?: any): Promise<Blob> => {
  ...
  exportStudentsPDF: async (filters?: any): Promise<Blob> => {
